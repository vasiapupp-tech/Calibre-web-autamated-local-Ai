...
class ConfigSQL(object):
    ...
    def init_config(self, session, secret_key, cli):
        ...
        self.config_calibre_split = False
        self.config_calibre_split_dir = None
        self.config_use_google_drive = False
    ...
    def get_book_path(self):
        if getattr(self, 'config_calibre_split', False):
            return getattr(self, 'config_calibre_split_dir', None) or self.config_calibre_dir
        return self.config_calibre_dir
