"""Bookz.ru metadata provider (pirate library, HTML search)."""
...
class Bookz(BaseMetadataProvider, Metadata):
    __name__ = "Bookz"
    __id__ = "bookz"

    DESCRIPTION = "Bookz"
    META_URL = "https://bookz.ru/"
    SEARCH_URL = "https://bookz.ru/search/"
    DEFAULT_LIMIT = 7
    ...
    def search(
        ...
        log.info("Searching Bookz for: %s", query)
        ...
        log.info("Bookz search found %d results", len(results))
        return results
