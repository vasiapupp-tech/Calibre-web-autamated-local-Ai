"""Eksmo.ru metadata provider (publisher catalog, HTML search)."""
...
class Eksmo(BaseMetadataProvider, Metadata):
    __name__ = "Эксмо"
    __id__ = "eksmo"

    DESCRIPTION = "Эксмо"
    META_URL = "https://eksmo.ru/"
    SEARCH_URL = "https://eksmo.ru/search/"
    DEFAULT_LIMIT = 7
    ...
    def search(
        ...
        log.info("Searching Эксмо for: %s", query)
        ...
        log.info("Эксмо search found %d results", len(results))
        return results
    ...
    def _fetch_book(
        ...
        record.publisher = data["publisher"] or "Эксмо"
